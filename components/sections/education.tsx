  ...
  const education = [
    {
      ...
      location: "Thandalam, Tamil Nadu, India",
      period: "2021 - 2025",
      description:
        "Pursuing a degree in Computer Science and Engineering with a focus on software development and cybersecurity.",
    ...
    },
    {
      ...
      period: "2019 - 2021",
      description:
        "Completed higher secondary education with a focus on science and mathematics, achieving a strong academic record.",
